                ...
                <tbody>
                    <?php
                     if(mysqli_num_rows($query_run) > 0){
                        ...
                        <tr>
                            <td>
                                <i class="fab fa-angular fa-lg text-danger me-3"></i><strong><?php echo $row['student_id'];?></strong>
                            </td>
                            ...
                            <td>
                                ...
                                if($row['student_image'] == null){
                                    ?>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"data-bs-placement="top"class="avatar avatar-lg align-items-center pull-up"title="<?php echo $row['student_name'] ?>">
                                    ...
                                    ?>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"data-bs-placement="top"class="avatar avatar-lg align-items-center pull-up"title="<?php echo $row['student_name'] ?>">
                                                <img src="<?php echo "../student/uploads/students/".$row['student_image'] ?>" alt="Avatar" class="rounded-5"/>
                                            </li>
                                        </ul>
                                    <?php
                                }
                                ...
                                <td>
                                    <a class="dropdown-item btn-primary text-center rounded-5" href="student_edit.php?id=<?php echo $row['student_id'];?>">
                                        <i class="bx bx-edit-alt me-1"></i></a>
                                </td>
                                <td>
                                    <form action="../db/code.php" method="post">
                                        <input type="hidden" name="deletestudent_id" value="<?php echo $row['student_id'];?>">
                                        <button type="submit" name="studentDeleteBtn" class="dropdown-item btn-danger btn-sm align-items-center text-center " href="javascript:void(0);"><i class="bx bx-trash me-1"></i></button>
                                    </form>
                                </td>
                        </tr>
                        <?php
