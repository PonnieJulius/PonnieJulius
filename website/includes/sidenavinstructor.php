<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Ponnie Works</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active mb-2">
              <a href="instructor_dashboard.php" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="course.php" class="menu-link">
                    <div data-i18n="Notifications">Add a Course</div>
                  </a>
                </li>
                <li class="menu-item">
